...
class Dataset(object):
    ...
    def process_train(self):
        ...
        #         temp_row.append([self.train_data_raw[i + j][4], self.train_data_raw[i + j][-1], self.train_target_raw[i + j][4]])
            
        #     train_data.append(temp_row)
        #     temp_row = list()
        
        # train_target = self.train_target_raw[self.timesteps:, 4]
    ...
    def process_test(self):
        ...
        #     test_data.append(temp_data_row)
        #     temp_data_row = list()
        # test_target = self.test_target_raw[self.timesteps:, 4]
        # print (test_target)
        # return test_data, test_target
